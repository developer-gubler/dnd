...
(
    ...
    CONSTRAINT unique_cr_value UNIQUE (value),
    CHECK (cr > 0),
    CHECK (experience > 0)
);
...
(
    id identity primary key,
    classification_id bigint NOT NULL REFERENCES creature_classification(id),
    name VARCHAR(32) NOT NULL,
...
(
    id identity primary key,
    name VARCHAR(32) NOT NULL,
    family_id bigint NOT NULL REFERENCES creature_family(id),
    creature_size_id bigint NOT NULL REFERENCES creature_size(id),
    alignment_id bigint NOT NULL REFERENCES alignment(id),
    ...
    challenge_rating_id smallint NOT NULL REFERENCES challenge_rating(id),
...
(
    id identity primary key,
    creature_id bigint NOT NULL REFERENCES creature(id),
    armor_id bigint NOT NULL REFERENCES armor(id)
);
...
(
    id identity primary key,
    creature_id bigint NOT NULL REFERENCES creature(id),
    weapon_id bigint NOT NULL REFERENCES weapon(id)
);
